...
func IsLatestVersion() (bool, GithubRelease, error) {
	releaseUrl := "https://api.github.com/repos/lmhd/lucli/releases/latest"
...
func updateAsset(releaseData GithubRelease) (GithubReleaseAsset, error) {
	...
	updateName := fmt.Sprintf("lucli.%s.%s", runtime.GOOS, runtime.GOARCH)
...
// Update updates lucli to the specific GithubRelease
