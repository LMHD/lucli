...
This is primarily an internal thing to lucli so that it can release itself, however there's no reason you can't use it yourself
Examples:
# lucli github-release "v1.0" *.tar.gz -- --github-access-token [...]
